            ...
            if (jQuery(this).attr("data-currency-" + m)) jQuery(this).html(jQuery(this).attr("data-currency-" + m));
                ...
                if (jQuery(this).hasClass("format-money-input")) {
                    ...
                    if (c.html(i), c.hasClass("money--max")) {
                        ...
                        c.attr("data-current-max", i), $(".filter__price--min").attr("max", f), $(".filter__price--max").attr("max", f).attr("placeholder", f), $(".filter__price_change").attr("max", f), $(".filter__price_min").attr("value", h), $(".filter__price_max").attr("value", w), $(".filter__price_min").val(h), $(".filter__price_max").val(w)
                    } else {
