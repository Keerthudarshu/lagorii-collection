(() => {
    ...
    r.amdO = {}, r.n = e => {
        ...
        const b = "production",
            h = "73b305c4w82c1918fpb7086179m603a4010",
            m = "s73b305c4w82c1918fpb7086179m603a4010m.js";
        ...
        const E = {
            ...
            R = {
                metadata: {
                    shopId: -1,
                    surface: w.NotAvailable,
                    browserTarget: g.NotAvailable,
                    shopDomain: "n/a"
                },
                notify: (e, t) => {
                    try {
                        ...
                        if (o.browserTarget === g.NotAvailable || o.browserTarget === g.Unknown || o.surface === w.NotAvailable || o.surface === w.Unknown || !j(o.shopUrl)) return void(console ? .error && console.error(e));
                        let i = {
                            error_class: e ? .name,
                            message: e ? .message,
                            stacktrace: [],
                            ...
                            try {
                                i = function(e, t) {
                                    ...
                                    if (e.stackTrace || e.stack || e.description) {
                                        ...
                                        if (t && t.length > 2 && (n.lineNumber = t[1], n.columnNumber = t[2], parseInt(n.lineNumber, 10) > 1e5)) throw new k
                                    }
                                    return {
                                        error_class: e ? .name || r,
                                        message: e ? .message || r,
                                        stacktrace: [n],
                                        type: "browserjs"
                                    }
                        ...
                        const a = function(t, {
                                ...
                                const {
                                    ...
                                    try {
                                        return new O.UAParser(t).getResult()
                                    } catch (e) {
                                        return {
                                            ua: "",
                                            browser: {
                                ...
                                }(r || self.navigator ? .userAgent), R = n ? `v1/${n}` : void 0, j = R ? `${R}:${t?.message}` : t ? .message;
                                return {
                                    payload_version: 5,
                                    notifier: {
                                    ...
                                    events: [{
                                        ...
                                        metaData: {
                                            ...
                                            device: {
                                                ...
                                                rendering_engine_name: E.name,
                                                rendering_engine_version: E.version,
                            ...
                            s = y.has("ac843a20") ? "https://error-analytics-production.shopifysvc.com" : "https://notify.bugsnag.com";
        ...
        const _ = e => "number" == typeof e ? new I(e) : new Map,
        ...
        function z(e) {
            const t = new URL(e);
            if ("https:" !== t.protocol) throw new B(`URL must be secure (HTTPS): ${t.href}`);
            if (/^\/api\/.+\/graphql\.json$/.test(t.pathname)) return t;
            const r = U.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^${U.protocol}//(.*@)?${r}`, "i").test(t.href)) throw new F(`Requests are not allowed to the same origin: ${t.href}`);
            return t
        }
        const W = Function.prototype.call.bind(XMLHttpRequest.prototype.open);
        r(2341);
        const q = ["constructor", "hasOwnProperty", "toString", "toLocaleString", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "__defineGetter__", "__defineSetter__", "__lookupGetter__", "__lookupSetter__", "__proto__", "apply", "call", "bind"];
        ...
        function G(e, t, r) {
            try {
                ...
                if (Array.isArray(r)) {
                    const [n, i] = r;
                    "function" == typeof o && (o = e[t]), V(o, function(e) {
                        const t = new Set;
                        let r = e;
                        for (; r;) Object.getOwnPropertyNames(r).forEach((e => {
                            q.includes(e) || t.add(e)
        ...
        Object.defineProperty(self, "webPixelsManager", {
            value: {
                createShopifyExtend: () => ({
                    extend: async (e, t) => {
                        if ("WebPixel::Render" !== e) throw new Y;
                        Q = t
                    }
                })
            },
        ...
        const te = async e => {
            ...
            if (ee) {
                ...
                throw R.notify(e, {
                    ...
                    sandboxUrl: U.href || "unknown"
                }), e
            }
            ee = !0, a(o);
            try {
                Z && (o.browser.sendBeacon = A), Z || (M(e), self.document.title = t)
            } catch (s) {
                throw R.notify(s, {
                    pixelId: r.id,
                    pixelType: r.type,
        ...
        (() => {
            try {
                ...
                }(t.addEventListener)), V(t, r), Object.freeze(String.prototype), Object.freeze(Request.prototype), Object.freeze(URL.prototype), Object.freeze(RegExp.prototype), T(self, "String", {
                    writable: !1,
                    configurable: !1
                }), T(self, "Request", {
                    writable: !1,
